...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_TLTDKPMGZQ'><label><input type="radio" autocomplete="off" name="radio_TLTDKPMGZQ" value="answer"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_TLTDKPMGZQ" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_TLTDKPMGZQ" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_TLTDKPMGZQ" value="x"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_TLTDKPMGZQ" value="x"></input> <span>aes(y = population)</span></label></div>
...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_ITHIBCMPBS'><label><input type="radio" autocomplete="off" name="radio_ITHIBCMPBS" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_ITHIBCMPBS" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_ITHIBCMPBS" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_ITHIBCMPBS" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_ITHIBCMPBS" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_TYSUWOXSBB'><label><input type="radio" autocomplete="off" name="radio_TYSUWOXSBB" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_TYSUWOXSBB" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_TYSUWOXSBB" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_TYSUWOXSBB" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
