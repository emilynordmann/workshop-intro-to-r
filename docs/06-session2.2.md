...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_XDCRLPLILA'><label><input type="radio" autocomplete="off" name="radio_XDCRLPLILA" value="answer"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_XDCRLPLILA" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_XDCRLPLILA" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_XDCRLPLILA" value="x"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_XDCRLPLILA" value="x"></input> <span>aes(y = population)</span></label></div>
...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_GCQOJRENVI'><label><input type="radio" autocomplete="off" name="radio_GCQOJRENVI" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_GCQOJRENVI" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_GCQOJRENVI" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_GCQOJRENVI" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_GCQOJRENVI" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_KJEFMNQRDH'><label><input type="radio" autocomplete="off" name="radio_KJEFMNQRDH" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_KJEFMNQRDH" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_KJEFMNQRDH" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_KJEFMNQRDH" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
